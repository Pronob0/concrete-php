						...
						<div class="tab-content">
							<div class="tab-pane fade in active" id="tab-1">
								<div class="all-menu-details">
									<h5>Basic Building Materials</h5>
						<?php  
							$sql = mysqli_query($con, "SELECT * FROM product WHERE category = 'Basic Building Materials' ");
											...
											<div class="visible-option">
												<a href="view.php?id=<?= $row['id'] ;?>">
													<div class="details">
														...
														<p>
															Available: <b> <?= $row['quantity'] ;?></b> Pack
														</p>
														<p>Per pack contain 50Kg cement.</p>
